...
import ProductStatusEdit from "./ProductStatusEdit";
...
export default function ProductCategoryListPage () {
    ...
    return (
        <>
            ...
            />
            <ProductEdit cref={hotelEdit} onEditFinish={(r)=>{if(r)loadData()}}/>
            <ProductStatusEdit cref={statusEdit} onEditFinish={(r)=>{if(r)loadData()}}/>
        </>
    );
